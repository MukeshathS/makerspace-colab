...
urlpatterns = [
    ...
    path('password_reset/done/', auth_views.PasswordResetCompleteView.as_view(template_name='profile/registration/password_reset_done.html'), name='password_reset_done'),
    ...
    path('reset/done/', auth_views.PasswordResetCompleteView.as_view(template_name='profile/registration/password_reset_complete.html'),name='password_reset_complete'),
]
